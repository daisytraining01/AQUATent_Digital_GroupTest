...
public class TwoScenarios_WordPress_TestNG 
{
	...
	public void sampleTestNgWordPressSignUpTest() throws InterruptedException {
        ...
        el15.click();
        MobileElement el16 = (MobileElement) driver.findElementByAccessibilityId("Me");
        el16.click();
        MobileElement el17 = (MobileElement) driver.findElementById("org.wordpress.android:id/me_my_profile_text_view");
        el17.click();
	    ...
	    el127.click();
	    Thread.sleep(3000);
	    System.out.println("First testcase Execution Completed Successfully");
	...
	public void sampleWordPressLoginTest() throws Exception {
	    ...
	    System.out.println("Second testcase Execution Completed Successfully");
       }
